        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/50 border border-zinc-800 rounded-2xl p-8 mb-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
              {[
                { name: "TOKYO", slug: "tokyo", color: "blue" },
                { name: "LONDON", slug: "london", color: "purple" },
                { name: "NYC", slug: "nyc", color: "green" },
                { name: "PARIS", slug: "paris", color: "pink" },
                { name: "SYDNEY", slug: "sydney", color: "cyan" },
                { name: "DUBAI", slug: "dubai", color: "orange" },
                { name: "BERLIN", slug: "berlin", color: "red" },
                { name: "TORONTO", slug: "toronto", color: "yellow" },
                { name: "MUMBAI", slug: "mumbai", color: "indigo" },
                { name: "SEOUL", slug: "seoul", color: "teal" },
                { name: "MADRID", slug: "madrid", color: "rose" },
                { name: "BANGKOK", slug: "bangkok", color: "emerald" },
              ].map((city) => (
